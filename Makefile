...
test: output libmessagepassing.a test_message_passing.cpp test_message_passing.h
	$(CPP) $(DEBUG) $(WARN) $(STD) -L build/lib -lmessagepassing test_message_passing.cpp -o test_message_passing
...
thread_pool.o: output message_passing_interfaces.o thread_pool.cpp thread_pool.h
	$(CPP) $(DEBUG) $(WARN) $(STD) thread_pool.cpp -c -o build/object/thread_pool.o

message_passing_interfaces.o: output message_passing_interfaces.cpp message_passing_interfaces.h
	$(CPP) $(DEBUG) $(WARN) $(STD) message_passing_interfaces.cpp -c -o build/object/message_passing_interfaces.o
